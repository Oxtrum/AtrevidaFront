...
const LINKS_SERVICIOS = [
  { label: 'E Pulse Bike', href: '#servicios' },
  { label: 'Lipo Láser', href: '#servicios' },
  { label: 'Maderoterapia', href: '#servicios' },
  { label: 'Ondas Rusas', href: '#servicios' },
  { label: 'Radiofrecuencia', href: '#servicios' },
  { label: 'Vacumterapia', href: '#servicios' },
];
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            ...
            <div className={styles.socialRow}>
              ...
              <a href={buildBusinessWhatsappUrl() ?? '#'} className={styles.socialBtn} aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
          ...
          <div className={styles.ctaCol}>
            <h4 className={styles.colTitle}>¿Lista para tu cambio?</h4>
