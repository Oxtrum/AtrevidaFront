...
## Corpus Check
- 138 files · ~2,992,047 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1432 nodes · 2399 edges · 100 communities (86 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `373f879e`
...
- `ReservaDetailModalProps` --references--> `ReservaBD`  [EXTRACTED]
  components/AdminReservas/ReservaDetailModal.tsx → types/reserva.ts
...
- `readProfileInfo()` --calls--> `getStoredAdminUser()`  [EXTRACTED]
...
Cohesion: 0.15
Nodes (13): DayInfo, DaySelectorProps, CalendarGridProps, DIA_CORTO, DIAS, CalendarGridProps, DIA_CORTO, DIAS (+5 more)
...
Cohesion: 0.05
Nodes (64): StatCard(), StatCardProps, StatGrid(), StatGridProps, ReservasTable(), ReservasTableProps, CATEGORIAS_ORDEN, actualizarEstadoReservaDB() (+56 more)
...
Cohesion: 0.18
Nodes (12): ConfiguracionPage(), EMPTY_PASSWORD_FORM, EMPTY_PASSWORD_VISIBILITY, formatTokenDate(), getRoleLabel(), OPTIONS, PasswordErrors, PasswordForm (+4 more)
...
Cohesion: 0.21
Nodes (11): AdminAccessButtonProps, AdminTokenClaims, AdminUserSession, canViewAdminPayments(), canViewFinancialReports(), clearStoredAdminSession(), getRoleFromToken(), getStoredAdminRole() (+3 more)
...
Cohesion: 0.27
Nodes (9): PageHeader(), PageHeaderProps, renderTitle(), crearLocalDB(), getLocalesDB(), Espacio, FormErrors, LocalesPage() (+1 more)

### Community 27 - "Community 27"
Cohesion: 0.14
Nodes (17): RowActionsMenu(), ESTADO_CLASS, formatTimestamp(), ReservaDetailModal(), ReservaDetailModalProps, eliminarReservaDB(), ReservaTipoBackend, CustomSelect() (+9 more)
...
Cohesion: 0.14
Nodes (15): AdminPanel, AdminPanelProps, Column, DataTable(), DataTableProps, FormModal(), FormModalProps, RowAction (+7 more)
...
Cohesion: 0.33
Nodes (6): buildFilters(), getCurrentMonthValue(), getInitialRange(), getMonthRange(), pad(), toDateInputValue()
...
Cohesion: 0.10
Nodes (25): activarServicioEnLocal(), ActivarServicioEnLocalData, ActualizarLocalData, actualizarServicio(), ActualizarServicioData, ComboServicioCreateData, ComboServicioUpdateData, CrearLocalData (+17 more)
...
Cohesion: 0.11
Nodes (30): useReservationForm(), useCrearReserva(), Local, LocalesResponse, useLocales(), UseLocalesReturn, useReservas(), UseReservasParams (+22 more)
...
Cohesion: 0.16
Nodes (16): getReservasCalendario(), Calendar(), CalendarProps, CalendarAdmin(), CalendarAdminProps, CalendarPublico(), CalendarPublicoProps, CustomSelect() (+8 more)
...
Cohesion: 0.08
Nodes (17): ActiveFilters, addTable(), AddTableOptions, ALL_BORDERS, buildMonthlyFileName(), buildRangeFileName(), CHART_COLORS, EMPTY_DETAIL_REPORTS (+9 more)
...
Cohesion: 0.16
Nodes (21): DaySelector(), ServiceGroup, ServiceSelect(), ServiceSelectProps, TimeSlotPicker(), TimeSlotPickerProps, getReservaByID(), getServiciosDB() (+13 more)
...
Cohesion: 0.08
Nodes (38): ReservationCardProps, SlotBadges(), SlotBadgesProps, agruparReservas(), TimeSlot(), TimeSlotProps, TimeSlotAdmin(), TimeSlotAdminProps (+30 more)

### Community 99 - "Community 99"
Cohesion: 0.33
Nodes (6): apiClient, ApiError, getAuthToken(), request(), RequestOptions, expireAdminSessionAndRedirect()
...
Cohesion: 0.17
Nodes (15): getBusinessClosingTime(), getSaturdayClosingTime(), isSlotOutsideBusinessHours(), timeToMinutes(), ReservationFormProps, ServiceGroup, ServiceSelect(), ServiceSelectProps (+7 more)

## Knowledge Gaps
- **578 isolated node(s):** `eslintConfig`, `config`, `version`, `source`, `sourceType` (+573 more)
...
- **Why does `DiaSemana` connect `Community 8` to `Community 64`, `Community 97`, `Community 98`, `Community 102`, `Community 83`, `Community 19`, `Community 27`, `Community 93`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `toast` connect `Community 92` to `Community 64`, `Community 33`, `Community 1`, `Community 16`, `Community 84`, `Community 21`, `Community 30`, `Community 87`, `Community 26`, `Community 27`, `Community 61`, `Community 62`?**
