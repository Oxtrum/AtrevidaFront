...
export default function EditarLocalPage() {
  ...
  const fetchLocal = useCallback(async () => {
    ...
    try {
      ...
      router.push('/atrevida-gestion/configuracion/locales');
    } finally {
      setLoading(false);
    }
  }, [params.id, router]);
      ...
      <main className={styles.main}>
        ...
        <div ref={formRef} className={styles.form}>
          ...
          <div className={styles.actions}>
            <button className="admin-button admin-button-secondary" onClick={() => router.push('/atrevida-gestion/configuracion/locales')}>
              Cancelar
            </button>
